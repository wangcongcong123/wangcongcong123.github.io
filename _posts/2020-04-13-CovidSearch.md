...
corpus=["Covid-19 study on the spatiotemporal epidemic spreading of COVID-19",
"On transmission rates of the COVID-19 outbreak",
"A deductive approach to modeling the spread of COVID-19"]

stop_words = ["on","the","of","to","out"]

feature_names/vocabulary = ['19', 'approach', 'covid', 'covid19', 'deductive', 'epidemic', 'modeling', 'outbreak', 'rates', 'spatiotemporal', 'spread', 'spreading', 'transmission']


['19', 'approach', 'covid', 'deductive', 'epidemic', 'modeling', 'outbreak', 'rates', 'spatiotemporal', 'spread', 'spreading', 'study', 'transmission']


[0.45329466, 0.        , 0.45329466, 0.        , 0.38374728,
        0.        , 0.        , 0.        , 0.38374728, 0.        ,
        0.38374728, 0.38374728, 0.        ]


        Total number of documents (3 in this case)
...
corpus1 = [
    'This is the first document.',
     ...
     'And this is the third document one.',
